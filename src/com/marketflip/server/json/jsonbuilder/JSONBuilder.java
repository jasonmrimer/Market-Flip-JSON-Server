...
public class JSONBuilder {
	...
	/**
	 * Returns an entire JSON object representation to be called from the server
	 * based on the parameters parsed in the constructor.
	 * @param ...
	 * @return A string object of JSON data.
	 */
